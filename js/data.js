...
const BUILDINGS = {
  ...
  factory: {
    ...
    trainsByFaction: {
      coalition: ['bulwark', 'viper', 'aegis', 'thunder', 'goliath', 'citadel', 'leviathan', 'siege', 'detector'],
      dynasty: ['warlord', 'flak', 'aegis', 'salamander', 'goliath', 'citadel', 'leviathan', 'siege', 'detector'],
      cartel: ['jackal', 'guntruck', 'aegis', 'barrage', 'demorig', 'goliath', 'citadel', 'leviathan', 'siege', 'detector'],
    },
  },
  airfield: {
...
const UNITS = {
  ...
  albatross: {
    ...
    capacity: 20, gunPorts: 6,
    resist: { bullet: 0.5, gatling: 0.5 },
    desc: 'Coalition gunship-transport. Carries up to 20 soldiers, guns down infantry with its chin turret and fires rockets at armor. Up to 6 soldiers fire from the gun ports while aboard, and an active protection system deflects half of all incoming gunfire. Unload (F) deploys the troops.',
  ...
  obsidian: {
    ...
    armor: 'air', buildTime: 90, chassis: 'jet', air: true, ammo: 1, limitPer: 5,
    stealthAir: true, decloakOnFire: 2,
    desc: 'Coalition strategic bomber (max 5). Cloaked flying wing carrying ONE nuclear payload — a 22,500-damage detonation with a 400 blast, the largest in the arsenal, and it strikes structures at full force rather than the reduced damage other aircraft deal. Flies home to rearm after every drop.',
