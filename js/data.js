...
const FIELD_SERVICE_RATE = 84;              // hp/s to nearby vehicles and aircraft
...
const BUILDINGS = {
  ...
  repairbay: {
    ...
    sight: 6, desc: 'Automatically repairs nearby friendly vehicles and aircraft (96 hp/s).',
    healRadius: 200, healRate: 96,
  },
  market: {
...
const UPGRADES = {
  ...
  factory: [
    ...
    { key: 'vehiclerepair', name: 'Field Service', icon: '🔧', costMul: 0.75,
      desc: 'Factory mechanics repair nearby friendly vehicles and aircraft (84 hp/s, like a small Repair Center).' },
